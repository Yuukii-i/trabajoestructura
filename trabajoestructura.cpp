...
std::vector<Personaje*> crearPersonajes() {
	...
	Personaje* p1 = new Personaje("Jhon el esquizofrenico", "Esquizofrenia", "J1", 150, 20, 5, 1, 50, false, true,true, habilidadesP1, std::make_pair(0, 1),50);
	...
	Personaje* p2 = new Personaje("Hollow Knight", "Depresivo", "J1", 100, 20, 0, 20, 120, false, true,true, habilidadesP2, std::make_pair(0, 3),120);
	...
	Personaje* p3 = new Personaje("Umbra Bellator", "Trauma", "J1", 120, 40, 10, 3, 45, false, true,true, habilidadesP3, std::make_pair(0, 5),45);
	...
	Personaje* p4 = new Personaje("K", "Olvidado", "J1", 100, 16, 15, 2, 50, false, true,true, habilidadesP4, std::make_pair(0, 7),50);
	...
	Personaje* p5 = new Personaje("Sans", "Esquizofrenia", "J2", 90, 19, 5, 9, 50, false, true,true, habilidadesP5, std::make_pair(7, 1),50);
	...
	Personaje* p6 = new Personaje("Cuadro", "Depresivo", "J2", 200, 13, 0, 7, 120, false, true,true, habilidadesP6, std::make_pair(7, 3),120);
	...
	Personaje* p7 = new Personaje("Stanli", "Trauma", "J2", 120, 16, 10, 3, 45, false, true,true, habilidadesP7, std::make_pair(7, 5),45);
	...
	Personaje* p8 = new Personaje("J", "Olvidado", "J2", 140, 15, 15, 2, 50, false, true,true, habilidadesP8, std::make_pair(7, 7),50);
